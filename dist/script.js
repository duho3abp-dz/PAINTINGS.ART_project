...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ...
    duration: 7000,
    isModal: _modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"]
  });
  ...
  Object(_modules_checkTextInput__WEBPACK_IMPORTED_MODULE_4__["default"])({
    inputNameIdentifier: 'name'
  });
  Object(_modules_checkTextInput__WEBPACK_IMPORTED_MODULE_4__["default"])({
    inputNameIdentifier: 'message'
  });
});
...
var accordion = function accordion(_ref) {
  var headingsIdentifier = _ref.headingsIdentifier,
      blocksIdentifier = _ref.blocksIdentifier,
      headerActiveClass = _ref.headerActiveClass;
  var headings = document.querySelectorAll(headingsIdentifier);
  var blocks = document.querySelectorAll(blocksIdentifier);
  if (!headings.length || !blocks.length || headings.length !== blocks.length) return;
  var blocksheights = [];
  ...
  var showBlock = function showBlock(block, head, height) {
  ...
  var setHeightsAndHideBlocks = function setHeightsAndHideBlocks() {
    blocks.forEach(function (block, i) {
      blocksheights = [].concat(_toConsumableArray(blocksheights), [block.clientHeight]);
      hideBlock(block, headings[i]);
    });
  };

  var headingClickEvent = function headingClickEvent() {
    headings.forEach(function (head, i) {
      return head.addEventListener('click', function (e) {
        e.preventDefault();
        parseInt(blocks[i].style.height) ? hideBlock(blocks[i], head) : showBlock(blocks[i], head, blocksheights[i]);
      });
    });
  };
...
var checkTextInput = function checkTextInput(_ref) {
  var inputNameIdentifier = _ref.inputNameIdentifier;
  var inputs = document.getElementsByName(inputNameIdentifier);
  if (!inputs.length) return;

  var inputEvent = function inputEvent(e) {
    var input = e.currentTarget;
    var value = input.value;
    var letters = value.replace(/\W/igm, '');

    var lettersWithoutNumbers = _toConsumableArray(letters.replace(/\d/igm, ''));

    var clearValue = _toConsumableArray(value).filter(function (letter) {
      return !lettersWithoutNumbers.filter(function (str) {
        return letter === str;
      }).length;
    }).join('');
  ...
  inputs.forEach(function (input) {
    return input.addEventListener('input', inputEvent);
  });
};
...
var closeModal = function closeModal(elem) {
  elem.style.display = '';
...
/***/ "./src/js/modules/createFileName.js":
/*!******************************************!*\
  !*** ./src/js/modules/createFileName.js ***!
  \******************************************/
/*! exports provided: changeSplitName, correctViewName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeSplitName", function() { return changeSplitName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "correctViewName", function() { return correctViewName; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
var changeSplitName = function changeSplitName(arr) {
  return arr.reduce(function (res, str, ind) {
    return ind <= 0 ? [str] : ind >= arr.length - 1 ? [].concat(_toConsumableArray(res), [str]) : ["".concat(res, ".").concat(str)];
  }, []);
};

var correctViewName = function correctViewName(arr) {
  return arr.reduce(function (res, str, ind) {
    var corrStr = str.length > 6 ? "".concat(str.slice(0, 7), "...") : str;
    return ind <= 0 ? corrStr : "".concat(res, " .").concat(str);
  }, '');
};
...
/* harmony import */ var _createFileName__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createFileName */ "./src/js/modules/createFileName.js");
...
var dragAndDrop = function dragAndDrop(_ref) {
  var dropElementsSelector = _ref.dropElementsSelector,
      dropWrapSelector = _ref.dropWrapSelector;
  var dropElements = document.querySelectorAll(dropElementsSelector);
  if (!dropElements.length) return;

  var blockBacklight = function blockBacklight(input, light) {
    var block = input.closest(dropWrapSelector);
  ...
  var dropEvent = function dropEvent(e) {
    ...
    var checkSplitName = splitName.length > 2 ? Object(_createFileName__WEBPACK_IMPORTED_MODULE_3__["changeSplitName"])(splitName) : splitName;
    var correctName = Object(_createFileName__WEBPACK_IMPORTED_MODULE_3__["correctViewName"])(checkSplitName);
  ...
  ['dragenter', 'dragleave', 'dragover', 'drop'].forEach(function (eventName) {
    return dropElements.forEach(function (dropElement) {
      return dropElement.addEventListener(eventName, function (e) {
        e.preventDefault();
        e.stopPropagation();
        e.type === 'dragenter' || e.type === 'dragover' ? blockBacklight(dropElement, true) : blockBacklight(dropElement);
...
var filterElements = function filterElements(_ref) {
  var parentButtonsIdentifier = _ref.parentButtonsIdentifier,
      ...
      noContentBlockIdentifier = _ref.noContentBlockIdentifier;
  ...
  var noContentBlock = document.querySelector(noContentBlockIdentifier);
  ...
  var filterByName = function filterByName(name) {
    ...
    elements.forEach(function (element) {
      ...
      blockElements = [].concat(_toConsumableArray(blockElements), [element]);
    });
...
/* harmony import */ var _closeModal__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./closeModal */ "./src/js/modules/closeModal.js");
/* harmony import */ var _loading__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./loading */ "./src/js/modules/loading.js");
/* harmony import */ var _createFileName__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./createFileName */ "./src/js/modules/createFileName.js");
...
var form = function form(_ref) {
  var formsIdentifier = _ref.formsIdentifier,
      uploadIdentifier = _ref.uploadIdentifier,
      answerBlockClass = _ref.answerBlockClass,
      orderButtonClass = _ref.orderButtonClass,
      _ref$uploadDefaultTex = _ref.uploadDefaultText,
      uploadDefaultText = _ref$uploadDefaultTex === void 0 ? 'Файл не выбран' : _ref$uploadDefaultTex,
  ...
  var upload = document.querySelectorAll(uploadIdentifier);
  ...
  var createAnswerMask = function createAnswerMask(actualForm, answer, modal) {
    ...
    setTimeout(function () {
      answerBlock.remove();
      if (modal) Object(_closeModal__WEBPACK_IMPORTED_MODULE_15__["default"])(modal);
    }, durationAnswer);
  };
  ...
  var submitEvent = function submitEvent(e) {
    ...
    var calcTotal = actualForm.querySelector('[name="total"]');
    var formObj = Object.fromEntries(formData.entries());

    if (sizeSelect && sizeSelect.value === 'Выберите размер картины' || materialSelect && materialSelect.value === 'Выберите материал картины') {
      return;
    } else if (calcTotal) formObj = _objectSpread({}, formObj, {
      total: calcTotal.textContent
    });

    console.log(formObj);
    formButton.innerHTML += Object(_loading__WEBPACK_IMPORTED_MODULE_16__["default"])();
    Object(_services_services__WEBPACK_IMPORTED_MODULE_14__["postData"])('posts', formObj).then(function () {
      return createAnswerMask(actualForm, success, formModal);
    }).catch(function () {
      return createAnswerMask(actualForm, error, formModal);
    }).finally(function () {
      actualForm.reset();
      Object(_loading__WEBPACK_IMPORTED_MODULE_16__["default"])(formButton);
      upload.forEach(function (item) {
        return item.previousElementSibling.textContent = uploadDefaultText;
      });
    });
  };
  ...
  var inputEvent = function inputEvent(e) {
    ...
    var splitName = fileName.split('.');
    var checkSplitName = splitName.length > 2 ? Object(_createFileName__WEBPACK_IMPORTED_MODULE_17__["changeSplitName"])(splitName) : splitName;
    var correctName = Object(_createFileName__WEBPACK_IMPORTED_MODULE_17__["correctViewName"])(checkSplitName);
    upload.previousElementSibling.textContent = correctName;
  };

  forms.forEach(function (elem) {
    return elem.addEventListener('submit', submitEvent);
  });
  upload.forEach(function (elem) {
    return elem.addEventListener('input', inputEvent);
  });
};
...
var inputMask = function inputMask(_ref) {
  var inputNameIdentifier = _ref.inputNameIdentifier;
  var phoneInputs = document.getElementsByName(inputNameIdentifier);
  if (!phoneInputs.length) return;
  var value = '';
  var cursorPosition = 0;

  var addValue = function addValue(input) {
    return input.value = value;
  };

  var focusPhoneEvent = function focusPhoneEvent(e) {
    if (!value.length) {
      value = '+7(';
  ...
  var blurPhoneEvent = function blurPhoneEvent(e) {
    if (value === '+7(') {
      value = '';
      addValue(e.currentTarget);
    }
  ...
  var checkSizeNumbers = function checkSizeNumbers() {
  ...
  var transformationValue = function transformationValue(currentValue, enteredCharacter) {
    ...
    var numeral4 = clearValue.slice(3, 4);
    var numeral5 = clearValue.slice(4, 5);
    var numeral6 = clearValue.slice(5, 6);
    var numeral7 = clearValue.slice(6, 7);
    var numeral8 = clearValue.slice(7, 8);
    var numeral9 = clearValue.slice(8, 9);
    var numeral10 = clearValue.slice(9, 10);
    value = valueLength < 4 ? "+7(".concat(numeral1).concat(numeral2).concat(numeral3) : valueLength >= 4 && valueLength < 7 ? "+7(".concat(numeral1).concat(numeral2).concat(numeral3, ")").concat(numeral4).concat(numeral5).concat(numeral6) : valueLength >= 7 && valueLength < 9 ? "+7(".concat(numeral1).concat(numeral2).concat(numeral3, ")").concat(numeral4).concat(numeral5).concat(numeral6, "-").concat(numeral7).concat(numeral8) : "+7(".concat(numeral1).concat(numeral2).concat(numeral3, ")").concat(numeral4).concat(numeral5).concat(numeral6, "-").concat(numeral7).concat(numeral8, "-").concat(numeral9).concat(numeral10);
    cursorPosition = enteredCharacter === null ? cursorPosition : cursorPosition === 7 || cursorPosition === 11 || cursorPosition === 14 ? cursorPosition + 1 : cursorPosition;
  };
...
var slider = function slider(_ref) {
  ...
  if (verticalSlide) {
    frame.style.height = "".concat(slides[0].clientHeight, "px");
    wrap.style.height = "".concat(slides[0].clientHeight, "px");
  }
