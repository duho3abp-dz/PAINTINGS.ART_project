...
/* harmony import */ var _modules_mainAutoSlider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/mainAutoSlider */ "./src/js/modules/mainAutoSlider.js");
...
/***/ "./src/js/modules/mainAutoSlider.js":
/*!******************************************!*\
  !*** ./src/js/modules/mainAutoSlider.js ***!
  \******************************************/
...
var mainAutoSlider = function mainAutoSlider(_ref) {
  var slidesClass = _ref.slidesClass,
  ...
  var resetOptions = function resetOptions(wrap) {
    position = 1;
    height = position * 100;
    wrap.style.top = "-".concat(height, "%");
  };

  var deleteLastSlide = function deleteLastSlide() {
    var slides = slidesWrap.querySelectorAll(slidesClass);
    slides[quantitySlides].remove();
  };

  var createGenderHTML = function createGenderHTML(slide, src) {
    return slide.innerHTML = "<img src=".concat(src, " >");
  };

  var createNewSlide = function createNewSlide(wrap) {
  ...
  var animateSlider = function animateSlider(wrap) {
    height--;
    wrap.style.top = "-".concat(height, "%");

    if (height >= position * 100) {
      requestAnimationFrame(function () {
        return animateSlider(wrap);
      });
    } else {
      resetOptions(wrap);
      createNewSlide(wrap);
      deleteLastSlide();
      setTimeout(function () {
        return startAnimateSlider(wrap);
      }, 3000);
    }
  };
...
/* harmony default export */ __webpack_exports__["default"] = (mainAutoSlider);
...
var slider = function slider(_ref) {
  var frameIdentifier = _ref.frameIdentifier,
      ...
      directionTurningSlides = _ref.directionTurningSlides,
  ...
  var startAnimateSlider = function startAnimateSlider() {
    setInterval(function () {
      slideNumber = directionTurningSlides === 'next' ? slideNumber + 1 : slideNumber - 1; // changeSlide();
  ...
  if (verticalSlide) wrap.style.height = "".concat(slides[0].clientHeight, "px");
  startPosition();
  startAnimateSlider();
};
